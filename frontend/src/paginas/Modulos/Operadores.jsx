...
export default function Operadores() {
  ...
  const [anulandoGrupo, setAnulandoGrupo] = useState(null); // registro recién hecho, para anularlo aquí mismo
  ...
  return (
    <div className="admin-page">
            ...
            <form className="modal-form" onSubmit={handleRegistrarGrupo}>
              ...
              <div className="modal-actions">
                ...
                {!resultado ? (
                  ...
                  // ¿Te equivocaste (ej. número de personas)? Anúlalo aquí mismo.
                  <button
                    type="button"
                    className="btn-danger"
                    onClick={() => setAnulandoGrupo({
                      id_transaccion_op: resultado.id_transaccion_op,
                      operador: grupoOp.nombre,
                      num_personas: Number(grupo.num_personas) || 0,
      ...
      {/* Anular el registro recién hecho (revierte los puntos) */}
      {anulandoGrupo && (
        <ModalAnularOperador
          transaccion={anulandoGrupo}
          onCerrar={() => setAnulandoGrupo(null)}
          onAnulada={() => {
            setAnulandoGrupo(null);
            setGrupoOp(null);
            setResultado(null);
            cargar();
